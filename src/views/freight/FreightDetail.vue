...
export default class extends Vue {
    ...
    private OwnerDetail:any = {
      ...
      'lineInfoVO': {
        ...
        'lineCloudProjectVO': {
          ...
          'effectiveLineNum': 89076448,
          'isDelivery': -33289650,
          'limitRemark': 'ad consequat proident',
          'lineDeliveryInfoFORMS': [
            {
              'workingTimeEnd': 'dolore fugiat ali',
              'workingTimeStart': 'elit Lorem adipisicing fugiat'
            }
          ],
          'lineNum': -69025874,
          'lineSaleId': -72004621,
          'lineSaleName': 'pariatur elit id sunt',
          'projectId': 'id ut sint sunt',
          'projectName': 'ullamco ad',
          'projectState': -5692127,
          'receivingPoint': -20174612,
          'returnBill': 3104621,
          'runLineNum': -8661922,
          'runSpeed': -66831228,
          'timeDiff': 'minim reprehenderit adipisicing amet dolor',
          'updateDate': '1950-12-01T04:41:06.924Z',
          'updateId': 94637264,
          'warehouseCity': 36712303,
          'warehouseCityName': 'anim',
          'warehouseClose': 'id cillum proident',
          'warehouseContactName': 'et minim',
          'warehouseContactPhone': 'nulla ea et in veniam',
          'warehouseCounty': -39805294,
          'warehouseCountyName': 'sed',
          'warehouseDistrict': 'incididunt quis est Ut',
          'warehouseName': 'ut sunt',
          'warehouseOpen': 'cillum veniam',
          'warehouseProvince': 95051415,
          'warehouseProvinceName': 'eu in',
          'warehouseRemark': 'mollit do'
        },
        'lineDeliveryInfoFORMS': [
          {
            'workingTimeEnd': 'sed officia laboris',
            'workingTimeStart': 'voluptate cupidatat ut deserunt'
          }
        ],
        'lineId': 'officia Duis',
        'lineName': 'aute',
        'linePictureRelatedVO': {
          'createDate': '1941-09-16T00:31:39.266Z',
          'id': -73607632,
          'informationDescription': 'eiusmod ea sunt',
          'lineId': 'labore',
          'lineName': 'cillum ut in',
          'loadingVideo': 'proident nisi officia veniam',
          'otherPicture': 'incididunt',
          'warehouseLoadingPicture': 'tempor cillum sint officia Ex'
        },
        'lineRank': 'officia adipisicing anim',
        'lineSaleId': 58607697,
        'lineSaleName': 'laboris est',
        'lineSalePhone': 'consectetur reprehenderit incididunt minim culpa',
        'lineState': 49257031,
        'lineStateName': 'nostrud aliquip',
        'lineType': 33334345,
        'lineTypeName': 'laborum ullamco',
        'lineUrgent': 57408557,
        'lineUrgentName': 'reprehenderit ipsum Excepteur',
        'monthNum': -52726841,
        'projectId': 'dolore pariatur laboris',
        'projectName': 'aliquip se',
        'provinceArea': 16634661,
        'provinceAreaName': 'fugiat eiusmod aute',
        'returnBill': 63640892,
        'runSpeed': -68058485,
        'runTestState': 13704786,
        'runTestStateName': 'aute proident',
        'settlementCycle': -39222995,
        'settlementCycleName': 'aliqua ipsum irure mollit',
        'settlementDays': -76904332,
        'settlementDaysName': 'nisi incididunt sit sunt mollit',
        'shipperOffer': 14601287.104516774,
        'stabilityRate': 95214198,
        'stabilityRateName': 'laboris reprehenderit occaecat',
        'timeDiff': 'officia non do sint',
        'updateDate': '1974-07-15T23:43:22.807Z',
        'updateId': -56977095,
        'volume': 48404462.37531361,
        'waitDirveValidity': '1994-12-26T01:28:31.981Z'
      },
      'wayBillInfoVO': {
        'confirmFee': 'eu veniam',
        'deliverNum': 88521568,
        'departureDate': '1955-11-22T23:10:57.772Z',
        'gmFee': 'pariatur',
        'lineFee': 'ullamco reprehenderit ut dolor',
        'lineId': 'exercitati',
        'lineName': 'deserunt enim',
        'preFee': 'esse cillum in tempor amet',
        'secondConfirmFee': 'irure sed dolore',
        'status': 'irure eu amet id',
        'statusName': 'sed pariatur',
        'warehouseLocation': -63635247,
        'warehouseName': -88314437,
        'wayBillId': 'velit'
      }
    }
    ...
    private async fetchData(value: any) {
      const { data } = await freightDetail({ wayBillAmountId: value })
      if (data.success) {
